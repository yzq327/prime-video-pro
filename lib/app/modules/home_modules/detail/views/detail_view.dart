      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              // setState(() {
              //   currentSelectCollection.value = checkBoxStates[index]? 0: myCollectionsList[index].collectId;
                  ...
                  GestureDetector(
                      onTap: () {
                        CommonDialog.showAlertDialog(
                          ...
                          onCancel: () => controller.userEtController.text = '',
                          content: CreateCollectDialog(
                            userEtController: controller.userEtController,
                            handleClear: () =>
                                controller.userEtController.text = '',
                          ),
                        );
                      },
                      child: Icon(
